...
public class BaseTest {
    ...
    static class TestConfiguration {
        private TestConfiguration(FtpConfigProperties properties) throws IOException {
            properties.setPublicKey(Resources.toString(Resources.getResource("keypair.pub"), Charsets.UTF_8));
            properties.setPrivateKey(Resources.toString(Resources.getResource("keypair"), Charsets.UTF_8));
        }
    }
}
