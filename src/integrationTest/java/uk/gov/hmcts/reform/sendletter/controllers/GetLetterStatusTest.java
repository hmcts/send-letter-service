...
class GetLetterStatusTest {
    ...
    @Test
    void should_return_400_when_same_valid_json_is_sent_twice() throws Exception {
        // given
        given(tokenValidator.getServiceName("auth-header-value")).willReturn("some_service_name");
        ...
        String jsonDuplicate = Resources.toString(getResource("letter-with-pdf-duplicate.json"), UTF_8);
