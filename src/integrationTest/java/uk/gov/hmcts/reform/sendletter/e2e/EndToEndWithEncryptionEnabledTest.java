...
public class EndToEndWithEncryptionEnabledTest {
    ...
    // Decrypt encrypted zip file so that we can confirm if we are able to decrypt the encrypted zip using private key
